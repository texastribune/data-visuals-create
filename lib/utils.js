...
/**
 * Takes a source directory, a destination directory and a template context
 * and copies the source directory's file to the destination directory. The
 * provided context is used to replace template variables in any files that
 * have them. Returns an array of all the outputted files.
 *
 * @param {String} srcDir
